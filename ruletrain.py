...
def __train_lstm_crf_restaurant():
    ...
    aspect_terms_file = None
    opinion_terms_file = None
    ...
    if task == 'train':
        ...
        if label_task_pretrain == 'both':
            ...
            train_data, valid_data = datautils.get_data_amazon(vocab, aspect_terms_file, label_task_pretrain)
        else:
            train_data, valid_data = datautils.get_data_amazon(vocab, opinion_terms_file, label_task_pretrain)
    print('done')
...
def __train_neurule_double_joint():
    ...
    train_data_src1, valid_data_src1 = datautils.get_data_amazon(vocab, config.AMAZON_TERMS_TRUE2_FILE, 'aspect')
    train_data_src2, valid_data_src2 = datautils.get_data_amazon(vocab, config.AMAZON_TERMS_TRUE4_FILE, 'opinion')
