...
def __train_nrdj(word_vecs_file, train_tok_texts_file, train_sents_file, train_valid_split_file, test_tok_texts_file,
    ...
    dst_aspects_file = os.path.join(config.DATA_DIR, 'semeval14/nrdj-aspects-unk.txt')
    dst_opinions_file = os.path.join(config.DATA_DIR, 'semeval14/nrdj-opinions-unk.txt')
