...
SE14_REST_TRAIN_XML_FILE = join(DATA_DIR_SE14, 'restaurant/Restaurants_Train.xml')
SE14_REST_TRAIN_SENTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_train_sents.json')
SE14_REST_TRAIN_SENT_TEXTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_train_texts.txt')
SE14_REST_TRAIN_TOK_TEXTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_train_texts_tok.txt')
SE14_REST_TRAIN_OPINIONS_FILE = join(DATA_DIR_SE14, 'restaurant/train_restaurant_opinions.txt')
SE14_REST_TRAIN_DEP_PARSE_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_train_dep.txt')
SE14_REST_TEST_XML_FILE = join(DATA_DIR_SE14, 'restaurant/Restaurants_Test_Gold.xml')
SE14_REST_TEST_SENTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_test_sents.json')
SE14_REST_TEST_SENT_TEXTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_test_texts.txt')
SE14_REST_TEST_TOK_TEXTS_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_test_texts_tok.txt')
SE14_REST_TEST_DEP_PARSE_FILE = join(DATA_DIR_SE14, 'restaurant/restaurants_test_dep.txt')
SE14_REST_TEST_OPINIONS_FILE = join(DATA_DIR_SE14, 'restaurant/test_restaurant_opinions.txt')
