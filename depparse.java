...
//                        + " " + td.reln());
    ...
    public static void main(String[] args) throws IOException {
       parseLineFile("rinante-data/semeval14/laptops_train_texts_tok.txt",
               "rinante-data/semeval14/laptops-train-rule-dep.txt",
               "rinante-data/semeval14/laptops-train-rule-pos.txt");
    }
}